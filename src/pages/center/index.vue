            ...
            <div class="page__hd i-header">
                <div class="g-bda-userinfo">
                    ...
                    <div v-if="userData.nickName" class="g-bda-userinfo-70">
                        ...
                        <span v-if="signNum" class="userinfo-sign">CheckedIn {{signNum}}days</span>
                        <span v-else></span>
                    </div>
                    <div v-else class="g-bda-userinfo-70">
                        <text class="userinfo-nickname">Not yet authorized</text>
                        <text class="userinfo-sign">Click Authorize button</text>
                    </div>
                </div>
            </div>
                ...
                <div class="zan-panel" style="border-top:0px;border-bottom:0px;width: 100%">
                    ...
                    <div class="item-wrapper">
                        <div v-if="sign" class="unlock_v">
                            ...
                            <text class="open-word">Checkin time：{{signTime.createdAt}}</text>
                        </div>
                        <div v-else class="unlock_v">
                            <div class="unlock-btn-cicle">
                                <button class="circle-btn-sign" type="default" @click="_sign">Checkin</button>
                            </div>
                            <div class="open-word">Checkin</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="zan-panel zan-panel-lock">
                    ...
                    <div class="item-wrapper">
                        <div class="unlock_v">
                            ...
                            <div class="open-word">for better experience authorize access </div>
                        </div>
                    </div>
                </div>
...
<script type="text/ecmascript-6">
    ...
    export default{
        ...
        methods: {
            ...
            about () {
                common.showModal('Info',`CisGuide is a mini app for NUIST. by hero76.
                 This software is provided as is without warranty, the source code that powers the app is open source under the MIT license, reach out Wechat ID: baheroh for more information.`, false)
        },
            _getNewsCount () {
